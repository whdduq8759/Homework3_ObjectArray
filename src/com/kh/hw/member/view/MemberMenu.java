...
public class MemberMenu {
    ...
    public void insertMember() {
        ...
        while (true) {
            ...
            gender = sc.next();
            // .toLowerCase()는 대소문자 상관없이
            // equalsIgnoreCase 대소문자 상관없이 비교하는 것 (.toLowerCase() + .equals() )
            if (gender.equalsIgnoreCase("m") || gender.toLowerCase().equals("f")) {
                break;
            } else {
